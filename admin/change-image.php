    ...
    if(strlen($_SESSION['login'])==0)
         ...
         if(isset($_POST['update']))
        {
            ...
            // Code for move image into directory
             ...
             $query=mysqli_query($conn,"update post set PostImage='$imgnewfile' where id='$postid'");
            if($query)
            {
...
<?php
    $postid=intval($_GET['pid']);
    $query=mysqli_query($conn,"select PostImage,PostTitle from post where id='$postid' and Is_Active=1 ");
