...
if( $_GET['disid'])
{
	...
	$query=mysqli_query($conn,"update feedback set status='0' where id='$id'");
...
if($_GET['appid'])
{
	...
	$query=mysqli_query($conn,"update feedback set status='1' where id='$id'");
											...
											<div class="demo-box m-t-20">
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($conn,"Select feedback.id,  feedback.name,feedback.email,feedback.postingDate,feedback.comment,post.id as postid,post.PostTitle from  feedback join post on post.id=feedback.postId where feedback.status=1");
$cnt=1;
