...
$sql=mysqli_query($conn,"SELECT password FROM  accounts where username='$adminid' || email='$adminid'");
...
if (password_verify($password, $dbpassword)) {
 ...
 $conn=mysqli_query($conn,"update accounts set password='$newhashedpass' where username='$adminid'");
...
<html lang="en">
    <head>
        ...
        <title>Calligraphy | Add Category</title>
