<?php
    ...
    if(isset($_POST['submitsubcat']))
    {
            ...
            $status=1;
            $query=mysqli_query($conn,"insert into subcategory(CategoryId,Subcategory,SubCatDescription,Is_Active) values('$categoryid','$subcatname','$subcatdescription','$status')");
        if($query)
        {
...
<html lang="en">
    <head>
        <title>Calligraphy | Add Sub Category</title>
