...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Calligraphy | Dashboard</title>
    ...
    <?php include('includes/leftsidebar.php');?>
                    ...
                    <div class="container">
							...
							<div class="col-xs-12">
								<div class="page-title-box">
                                    ...
                                    <ol class="breadcrumb p-0 m-0">
                                        <li>
                                            <a href="dashboard.php">Calligraphy</a>
                                        </li>
                                        <li>
                                            <a href="#">Admin</a>
                                        </li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                ...
                                <?php $query=mysqli_query($conn,"select * from subcategory where Is_Active=1");
        ...
        <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">View posts</p>
      ...
      <a href="trash-posts.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                            ...
                            <a href="manage-comments.php"> <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    <i class="mdi mdi-layers widget-one-icon"></i>
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="User This Month">View Comments</p>
                                    <?php $query=mysqli_query($conn,"select * from feedback where status=1");
                                    $countcmt=mysqli_num_rows($query);
                                    ?>
