...
<html lang="en">
    <head>
        ...
        <title> Calligraphy | Manage SubCategories</title>
...
<button id="addToTable" class="btn btn-success waves-effect waves-light">Add <i class="mdi mdi-plus-circle-outline" ></i></button>
												...
												<div class="table-responsive">
                                                    <table class="table m-0 table-colored-bordered table-bordered-primary">
                                                        ...
                                                        <tbody>
<?php 
$query=mysqli_query($conn,"Select category.CategoryName as catname,subcategory.Subcategory as subcatname,subcategory.SubCatDescription as SubCatDescription,subcategory.PostingDate as subcatpostingdate,subcategory.UpdationDate as subcatupdationdate,subcategory.SubCategoryId as subcatid from subcategory join category on subcategory.CategoryId=category.id where subcategory.Is_Active=1");
$cnt=1;
