...
$query=mysqli_query($conn,"update post set PostTitle='$posttitle',CategoryId='$catid',SubCategoryId='$subcatid',PostDetails='$postdetails',PostUrl='$url',Is_Active='$status' where id='$postid'");
if($query)
{
$msg="Post updated ";
}
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Calligraphy | Add Post</title>
...
<strong><?php echo htmlentities($error);?></strong></div>
<?php } ?>
